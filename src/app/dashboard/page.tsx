          ...
          {articles.map((article) => {
            ...
            return (
              <Link
                ...
                className="block bg-white rounded-xl border border-ink-100 p-5 hover:shadow-card-hover hover:border-ink-200 transition-all duration-200 group"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className={`status-badge ${config.class} flex-shrink-0`}>
                        {config.label}
                      </span>
                    </div>

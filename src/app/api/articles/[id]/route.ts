...
export async function PUT(
  ...
  const { headline, subHeadline, bodyContent, bodyHtml, featuredImage, featuredImageId, featuredImageCaption, tags } = body;
  ...
  if (featuredImageCaption !== undefined) updateData.featuredImageCaption = featuredImageCaption;

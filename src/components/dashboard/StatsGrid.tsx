...
function StatCard({
  ...
  return (
    <div className={`bg-white dark:bg-ink-900 rounded-xl border p-3 md:p-5 transition-all duration-300 ${
      ...
      <div className="flex items-center justify-between mb-2 md:mb-3">
        <div className={`w-7 h-7 md:w-9 md:h-9 rounded-lg flex items-center justify-center ${colorMap[color]} transition-all duration-300 ${
      ...
      <p className="text-xl md:text-2xl font-display font-bold text-ink-900 dark:text-ink-100">
